...
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/styles/bootstrap4/bootstrap.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/plugins/fontawesome-free-5.0.1/css/fontawesome-all.css')}}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/plugins/OwlCarousel2-2.2.1/owl.carousel.css')}}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/plugins/OwlCarousel2-2.2.1/owl.theme.default.css')}}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/plugins/OwlCarousel2-2.2.1/animate.css')}}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/plugins/slick-1.8.0/slick.css')}}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/styles/main_styles.css')}}">
<link rel="stylesheet" type="text/css" href="{{ URL::asset('TemplateUser/styles/responsive.css')}}">
...
<div class="super_container">
			...
			<div class="container">
				<div class="row">
					<div class="col d-flex flex-row">
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ url::asset('TemplateUser/images/phone.png')}}" alt=""></div>+38 068 005 3570</div>
						<div class="top_bar_contact_item"><div class="top_bar_icon"><img src="{{ url::asset('TemplateUser/images/mail.png')}}" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
						<div class="top_bar_content ml-auto">
							...
							<div class="top_bar_user">
								<div class="user_icon"><img src="{{ url::asset('TemplateUser/images/user.svg')}}" alt=""></div>
							...
							<div class="header_search_content">
								<div class="header_search_form_container">
									<form action="#" class="header_search_form clearfix">
										...
										<button type="submit" class="header_search_button trans_300" value="Submit"><img src="{{ url::asset('TemplateUser/images/search.png')}}" alt=""></button>
									</form>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-9 order-lg-3 order-2 text-lg-left text-right">
						<div class="wishlist_cart d-flex flex-row align-items-center justify-content-end">
							<div class="wishlist d-flex flex-row align-items-center justify-content-end">
								<div class="wishlist_icon"><img src="{{ url::asset('TemplateUser/images/heart.png')}}" alt=""></div>
							...
							<div class="cart">
								<div class="cart_container d-flex flex-row align-items-center justify-content-end">
									<div class="cart_icon">
										<img src="{{ url('TemplateUser/images/cart.png')}}" alt="">
					...
					<div class="col">
						...
						<div class="page_menu_content">
							...
							<div class="menu_contact">
								<div class="menu_contact_item"><div class="menu_contact_icon"><img src="{{ url::asset('TemplateUser/images/phone_white.png')}}" alt=""></div>+38 068 005 3570</div>
								<div class="menu_contact_item"><div class="menu_contact_icon"><img src="{{ url::asset('TemplateUser/images/mail_white.png')}}" alt=""></div><a href="mailto:fastsales@gmail.com">fastsales@gmail.com</a></div>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="banner">
		<div class="banner_background" style="background-image: url({{ url('TemplateUser/images/banner_background.jpg')}})"></div>
		<div class="container fill_height">
			<div class="row fill_height">
				<div class="banner_product_image"><img src="{{ url::asset('TemplateUser/images/banner_product.png')}}" alt=""></div>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ url::asset('TemplateUser/images/char_1.png')}}" alt=""></div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ url::asset('TemplateUser/images/char_2.png')}}" alt=""></div>
						<div class="char_content">
							<div class="char_title">Free Delivery</div>
							<div class="char_subtitle">from $50</div>
						</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ url::asset('TemplateUser/images/char_3.png')}}" alt=""></div>
						<div class="char_content">
							<div class="char_title">Free Delivery</div>
							<div class="char_subtitle">from $50</div>
						</div>
				...
				<div class="col-lg-3 col-md-6 char_col">
					...
					<div class="char_item d-flex flex-row align-items-center justify-content-start">
						<div class="char_icon"><img src="{{ url::asset('TemplateUser/images/char_4.png')}}" alt=""></div>
						<div class="char_content">
							<div class="char_title">Free Delivery</div>
							<div class="char_subtitle">from $50</div>
						</div>
						...
						<div class="deals_slider_container">
							...
							<div class="owl-carousel owl-theme deals_slider">
								...
								<div class="owl-item deals_item">
									<div class="deals_image"><img src="{{ url::asset('TemplateUser/images/deals.png')}}" alt=""></div>
								...
								<div class="featured_slider slider">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_1.png')}}" alt=""></div>
									...
									<div class="featured_slider_item">
										...
										<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_2.png')}}" alt=""></div>
											<div class="product_content">
									...
									<div class="featured_slider_item">
										...
										<div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_3.png')}}" alt=""></div>
											<div class="product_content">
												<div class="product_price">$379</div>
									...
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_4.png')}}" alt=""></div>
											<div class="product_content">
												<div class="product_price discount">$225<span>$300</span></div>
									...
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_5.png')}}" alt=""></div>
											<div class="product_content">
									...
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_6.png')}}" alt=""></div>
											<div class="product_content">
												<div class="product_price">$379</div>
									...
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item is_new d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_7.png')}}" alt=""></div>
											<div class="product_content">
												<div class="product_price">$379</div>
									...
									<div class="featured_slider_item">
										<div class="border_active"></div>
										<div class="product_item d-flex flex-column align-items-center justify-content-center text-center">
											<div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{ url::asset('TemplateUser/images/featured_8.png')}}" alt=""></div>
											<div class="product_content">
												<div class="product_price">$225</div>
