...
<!-- //for-mobile-apps -->
<!-- Custom Theme files -->
<link href="{{ URL::asset('LayoutUser/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{ URL::asset('LayoutUser/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{ URL::asset('LayoutUser/css/fasthover.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{ URL::asset('LayoutUser/css/popuo-box.css')}}" rel="stylesheet" type="text/css" media="all" />
<!-- //Custom Theme files -->
<!-- font-awesome icons -->
<link href="{{ URL::asset('LayoutUser/css/font-awesome.css')}}" rel="stylesheet"> 
<!-- //font-awesome icons -->
<!-- js -->
<script src="{{ URL::asset('LayoutUser/js/jquery.min.js')}}"></script>
<link rel="stylesheet" href="{{ URL::asset('LayoutUser/css/jquery.countdown.css')}}" /> <!-- countdown --> 
<!-- //js -->  
<!-- web fonts --> 
...
<body>
	...
	<script type="text/javascript" src="{{ URL::asset('LayoutUser/js/bootstrap-3.1.1.min.js')}}"></script>
	<!-- //for bootstrap working -->
	<!-- header modal -->
				...
				<div class="modal-body modal-body-sub">
					<div class="row">
						<div class="col-md-8 modal_body_left modal_body_left1" style="border-right: 1px dotted #C2C2C2;padding-right:3em;">
							...
							<script src="{{ URL::asset('LayoutUser/js/easyResponsiveTabs.js')}} " type="text/javascript"></script>
							<script type="text/javascript">
								...
								<div class="row">
									...
									<div class="col-sm-4">
										<div class="w3ls_products_pos">
											<h4>30%<i>Off/-</i></h4>
											<img src="{{ url::asset('LayoutUser/images/1.jpg')}}" alt=" " class="img-responsive" />
										</div>
									</div>
		...
		<div class="container">
			<div class="col-md-5 wthree_banner_bottom_left">
				<div class="video-img">
					...
					<!-- pop-up-box -->     
					<script src="{{ URL::asset('LayoutUser/js/jquery.magnific-popup.js')}}" type="text/javascript"></script>
					<!--//pop-up-box -->
					...
					<div id="myTabContent" class="tab-content">
							...
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{ URL::asset('LayoutUser/images/3.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ URL::asset('LayoutUser/images/4.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ URL::asset('LayoutUser/images/5.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ URL::asset('LayoutUser/images/6.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ URL::asset('LayoutUser/images/7.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ URL::asset('LayoutUSer/images/3.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ URL::asset('LayoutUser/images/4.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ URL::asset('LayoutUser/images/5.jpg')}}" alt=" " class="img-responsive" />
						...
						<div role="tabpanel" class="tab-pane fade" id="audio" aria-labelledby="audio-tab">
							<div class="agile_ecommerce_tabs">
								<div class="col-md-4 agile_ecommerce_tab_left">
									<div class="hs-wrapper">
										<img src="{{ url::asset('LayoutUser/images/8.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ url::asset('LayoutUser/images/9.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ url::asset('LayoutUser/images/10.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ url::asset('LayoutUser/images/8.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ url::asset('LayoutUser/images/9.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ url::asset('LayoutUser/images/10.jpg')}}" alt=" " class="img-responsive" />
										<img src="{{ url::asset('LayoutUser/images/8.jpg')}}" alt=" " class="img-responsive" />
			...
			<div class="w3agile_special_deals_grids">
				<div class="col-md-7 w3agile_special_deals_grid_left">
					<div class="w3agile_special_deals_grid_left_grid">
						<img src="{{ url::asset('LayoutUser/images/21.jpg')}}" alt=" " class="img-responsive" />
					...
					<div class="wmuSlider example1">
						<div class="wmuSliderWrapper">
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										<img src="{{ url::asset('LayoutUser/images/t1.png')}}" alt=" " class="img-responsive" />
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										<img src="{{ url::asset('LayoutUser/images/t2.png')}}" alt=" " class="img-responsive" />
										<p>Quis autem vel eum iure reprehenderit qui in ea voluptate 
											velit esse quam nihil molestiae consequatur, vel illum qui dolorem 
											eum fugiat quo voluptas nulla pariatur</p>
										<h4>Michael</h4>
							...
							<article style="position: absolute; width: 100%; opacity: 0;"> 
								<div class="banner-wrap">
									<div class="w3agile_special_deals_grid_left_grid1">
										<img src="{{ url::asset('LayoutUser/images/t3.png')}}" alt=" " class="img-responsive" />
										<p>Quis autem vel eum iure reprehenderit qui in ea voluptate 
											velit esse quam nihil molestiae consequatur, vel illum qui dolorem 
											eum fugiat quo voluptas nulla pariatur</p>
										<h4>Rosy</h4>
		...
		<div class="container">
			...
			<div class="agileinfo_new_products_grids">
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{ url::asset('LayoutUser/images/25.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/23.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/24.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/22.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/26.jpg')}}" alt=" " class="img-responsive" /> 
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{ url::asset('LayoutUser/images/27.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/28.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/29.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/30.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/31.jpg')}}" alt=" " class="img-responsive" /> 
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li>
										<a href="#" data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{ url::asset('LayoutUser/images/34.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/33.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/32.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/35.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/36.jpg')}}" alt=" " class="img-responsive" /> 
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li>
				...
				<div class="col-md-3 agileinfo_new_products_grid">
					<div class="agile_ecommerce_tab_left agileinfo_new_products_grid1">
						<div class="hs-wrapper hs-wrapper1">
							<img src="{{ url::asset('LayoutUser/images/37.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/38.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/39.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/40.jpg')}}" alt=" " class="img-responsive" />
							<img src="{{ url::asset('LayoutUser/images/41.jpg')}}" alt=" " class="img-responsive" /> 
							<div class="w3_hs_bottom w3_hs_bottom_sub">
								<ul>
									<li>
	...
	<div class="top-brands">
		<div class="container">
			...
			<div class="sliderfig">
				<ul id="flexiselDemo1">			
					<li>
						<img src="{{ url::asset('LayoutUser/images/tb1.jpg')}}" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{ url::asset('LayoutUser/images/tb2.jpg')}}" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{ url::asset('LayoutUser/images/tb3.jpg')}}" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{ url::asset('LayoutUser/images/tb4.jpg')}}" alt=" " class="img-responsive" />
					</li>
					<li>
						<img src="{{ url::asset('LayoutUser/images/tb5.jpg')}}" alt=" " class="img-responsive" />
					</li>
				</ul>
			</div>
			<script type="text/javascript">
			...
			<script type="text/javascript" src="{{ URL::asset('LayoutUser/js/jquery.flexisel.js')}}"></script>
		</div>
	</div>
	<!-- //top-brands --> 
	<!-- newsletter -->
		...
		<div class="footer-copy">
			<div class="footer-copy1">
				<div class="footer-copy-pos">
					<a href="#home1" class="scroll"><img src="{{ url::asset('LayoutUser/images/arrow.png')}}" alt=" " class="img-responsive" /></a>
				</div>
			</div>
			<div class="container">
